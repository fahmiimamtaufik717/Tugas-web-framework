...
<div class="page">
    ...
    <form action="{{ route('movies.destroy', $movie->id) }}" method="POST" id="deleteForm">
    @csrf
    @method('DELETE')
    <button type="button" class="delete-btn" onclick="showDialog()">
  ...
  <div class="dialog-container" id="dialogContainer">
    <div class="dialog-box">
      ...
      <div class="button-container">
        <button class="button yes" onclick="handleYes()">Ya</button>
        <button class="button no" onclick="handleNo()">Tidak</button>
      </div>
    </div>
  </div>
